...
<html lang="es">
    ...
    <section class="container container-fluid pt-4">
        <div class="row" style="margin-top:1rem;">
            @foreach ( $producto as $articulo )
                <div class="col-lg-3 col-md-3 col-sm-12 p-2"></div>
                <div class="col-lg-6 col-md-6 col-sm-12 p-4 text-center  shadow-lg rounded ">
      
                    <a href="{{ route('articulos.show', $articulo->id) }}">
                    <img width="450px" height="450px"  class="pt-4" src="{{ asset('uploads/productos/'.$articulo->imagen) }}" class="card-img-top" title="{{ $articulo->descripcion }}" alt="{{ $articulo->descripcion }}"></a>
