            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="text-center text-white">
                        <!-- Page heading-->
                        <h1 class="mb-5 text-white shadow rounded-pill">¡Bienvenido!</h1>
                        <!-- Signup form-->
                        <!-- * * * * * * * * * * * * * * *-->
...
-->                                <!-- Email address input-->
                            ...
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a href="{{route('articulos')}}">
                                            <img width="400px" height="400px" src="/uploads/productos/carcasaprueba.jpg"  class="d-block w-100 rounded shadow-lg" alt="...">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a href="{{route('articulos')}}">
                                            <img width="400px" height="400px" src="/uploads/productos/carcasa8.jpg"  class="d-block w-100 rounded shadow-lg" alt="...">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 p-2">
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a href="{{route('articulos')}}">
                                            <img width="400px" height="400px" src="/uploads/productos/cargador.jpg"  class="d-block w-100 rounded shadow-lg" alt="...">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a href="{{route('articulos')}}">
                                            <img width="400px" height="400px" src="/uploads/productos/cargarapida.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                                        </a>
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="prev">
                ...
                <div class="col-lg-8 col-sm-12 p-2">
                    ...
                    <div class="carousel-inner d-flex">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <a href="{{route('articulos')}}">
                                <img  width="800px" height="815px" src="/uploads/productos/carcasa8.jpg" class="d-block w-100 rounded shadow-lg" alt="...">
                            </a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Protectores</h5>
                                <p>¡Encuentra carcasas iPhone de todos los diseños en Tropicool! </p>
                            </div>
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <a href="{{route('articulos')}}">
                                <img width="800px" height="815px" src="/uploads/productos/cargador.jpg"class="d-block w-100 rounded shadow-lg" alt="...">
                            </a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Cargadores</h5>
                                <p>¡Encuentra cargadores iPhone en Tropicool! </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="ftco-section text-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-12 p-4 overflow-hidden rounded col-sm-12">
                <iframe class="shadow-lg" width="500px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14719.269689674013!2d-72.40755232304765!3d-37.0332514778400px6!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x96696b9f5c409261%3A0xe109573d1fe50655!2zQ2FicmVybywgQsOtbyBCw61v!5e0!3m2!1ses-419!2scl!4v1658347780698!5m2!1ses-419!2scl" width="600" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="col-lg-2 col-md-2"></div>
            <div class="col-lg-4 col-xs-12 col-sm-12 p-4 overflow-hidden rounded">
                <iframe class="shadow-lg" width="500px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14764.635575155658!2d-73.05433459479566!3d-36.79855219785074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9669b5d061cae83d%3A0x8f2da2e9988cc125!2sUniversidad%20Cat%C3%B3lica%20de%20la%20Sant%C3%ADsima%20Concepci%C3%B3n!5e0!3m2!1ses-419!2scl!4v1658348010524!5m2!1ses-419!2scl" width="600" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="col-lg-1 col-md-1"></div>
        </div>
    </section>
