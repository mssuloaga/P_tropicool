<div class="card-body">
        ...
        <div class="row">
            <label  class="col-sm-2 col-form-label">Dirección</label>
                <div class="col-sm-7">
                {{ Form::text('direccion', $evento->direccion, ['class' => 'form-control' . ($errors->has('direccion') ? ' is-invalid' : ''), 'placeholder' => 'Dirección']) }}
        ...
        <div class="row">
            <label  class="col-sm-2 col-form-label">Valor</label>
                <div class="col-sm-7">
                {{ Form::text('precio', $evento->precio, ['class' => 'form-control' . ($errors->has('precio') ? ' is-invalid' : ''), 'placeholder' => 'Valor']) }}
