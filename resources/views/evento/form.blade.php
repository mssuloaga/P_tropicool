<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('id_trabajador', $evento->id_trabajador, ['class' => 'form-control' . ($errors->has('id_trabajador') ? ' is-invalid' : ''), 'placeholder' => 'Id Trabajador']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('id_empresas', $evento->id_empresas, ['class' => 'form-control' . ($errors->has('id_empresas') ? ' is-invalid' : ''), 'placeholder' => 'Id Empresas']) }}
